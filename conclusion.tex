...
We have developed two open-source software \DIFdelbegin \DIFdel{packages }\DIFdelend \DIFaddbegin \DIFadd{projects }\DIFaddend that implement the
\DIFdelbegin \DIFdel{components }\DIFdelend \DIFaddbegin \DIFadd{modules }\DIFaddend required for building an inversion method: forward modeling,
optimization, and regularization.
We used these \DIFdelbegin \DIFdel{components }\DIFdelend \DIFaddbegin \DIFadd{modules }\DIFaddend to develop a fast gravity inversion method to estimate
...
America.
\DIFdelbegin \DIFdel{Both software packages, the source code for the gravity inversion, and all
...
These values are included as defaults \DIFaddbegin \DIFadd{starting }\DIFaddend in version 1.2 of the software.
\DIFaddbegin \DIFadd{Previous versions of }\DIFaddend \textit{Tesseroids} \DIFdelbegin \DIFdel{has }\DIFdelend \DIFaddbegin \DIFadd{have }\DIFaddend been used in published research
by, for example,
