...
Conference \DIFdelbegin \DIFdel{(Scipy 2013).
}\DIFdelend \DIFaddbegin \DIFadd{in 2013
(}\DIFaddend \url{http://conference.scipy.org/proceedings/scipy2013/uieda.html}\DIFaddbegin \DIFadd{).
...
The official website (}\url{http://www.fatiando.org}\DIFadd{) contains more up-to-date
...
powerful Python scripting. The library can also be used as an API \DIFaddbegin \DIFadd{(Application
Programming Interface) }\DIFaddend for developing stand-alone programs.  Algorithms
...
0.1\DIFaddbegin \footnote{\DIFadd{
...
\DIFaddend of Fatiando a Terra is focused on gravity and magnetic methods because this is
...
\DIFaddend has a few state-of-the-art gravity and magnetic modeling and
