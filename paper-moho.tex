...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{figures/paper-moho/synthetic-crust1-results}
    \caption{
...
Fig.~\ref{fig:moho-crust1-results}c shows the final solution after both
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{figures/paper-moho/south-america-corrections}
    \caption{
...
We split the sediment-free gravity disturbance (Fig.~\ref{fig:moho-sam-data}a) into
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{figures/paper-moho/south-america-moho}
    \caption{
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{figures/paper-moho/south-america-residuals}
    \caption{
...
Fig.~\ref{fig:moho-sam-residuals}a shows the gravity residuals,
defined as the difference between the observed and predicted gravity data.
...
\DIFadd{The Moho depth model for South America estimated here can be downloaded from
the online repository
}\url{https://github.com/pinga-lab/paper-moho-inversion-tesseroids}\DIFadd{.
