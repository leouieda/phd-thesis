...
This chapter has been submitted for publication in the \DIFdelbegin \DIFdel{journal Geophysics in
collaboration with Dr. Carla Braitenberg of the University of Trieste, Italy}\DIFdelend \DIFaddbegin \DIFadd{``Geophysical Software
and Algorithms'' section of the journal GEOPHYSICS}\DIFaddend .
...
\DIFdelbegin \footnote{\DIFdel{
http://tesseroids.leouieda.com}}%DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\footnote{\DIFdel{
http://dx.doi.org/10.5281/zenodo.16033}}
%DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{(}\url{http://tesseroids.leouieda.com} \DIFadd{or
}\url{http://dx.doi.org/10.5281/zenodo.16033}\DIFadd{)
...
in \DIFdelbegin \DIFdel{an online repository
}\footnote{\DIFdel{
https://github.com/pinga-lab/paper-tesseroids}}%DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{the online repository
}\url{https://github.com/pinga-lab/paper-tesseroids}\DIFaddend .
...
yield better performance through a reduced number of divisions\DIFaddbegin \DIFadd{.
}
...
\DIFadd{The source code, compiled binary files, and user documentation for
}\textit{\DIFadd{Tesseroids}} \DIFadd{can be found at the project website
}\url{http://tesseroids.leouieda.com}\DIFadd{.
The source code for version 1.2 of }\textit{\DIFadd{Tesseroids}} \DIFadd{is permanently archived
at }\url{http://dx.doi.org/10.5281/zenodo.16033}\DIFadd{.
The data and source code that produced the results and figures presented here
