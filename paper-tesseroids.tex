...
This chapter has been submitted for publication in the ``Geophysical Software
and Algorithms'' section of the journal GEOPHYSICS.
...
(\url{http://tesseroids.leouieda.com} or
...
The source code, compiled binary files, and user documentation for
\textit{Tesseroids} can be found at the project website
\url{http://tesseroids.leouieda.com}.
The source code for version 1.2 of \textit{Tesseroids} is permanently archived
at \url{http://dx.doi.org/10.5281/zenodo.16033}.
